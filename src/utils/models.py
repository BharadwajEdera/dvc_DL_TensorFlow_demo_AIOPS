...
def prepare_model(model, CLASSES, freeze_all, freeze_till, learning_rate):
    ...
    '''
    Creating a Model Using Function based approch instead of Sequential Based approach in Tensorflow
    freeze_all = True ; to Freeze all the Layers into Base Model
    '''
    if freeze_all:
